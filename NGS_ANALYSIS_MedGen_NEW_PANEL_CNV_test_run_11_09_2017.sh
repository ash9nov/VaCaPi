...
#=======================================||---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# here we the CNV tool script will be run, with two variable passed to it $dir1, $smpl
#
#
#
export dir1
exoprt smpl
sh ~/my_tools/NGS_CNV_code/step1_shell_code_for_running_CNV_analysis_parallel.sh
#
#
#
#=======================================||---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
