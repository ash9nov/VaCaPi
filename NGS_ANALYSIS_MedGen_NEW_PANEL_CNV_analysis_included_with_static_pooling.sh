...
java -jar ~/my_tools/GATK/GenomeAnalysisTK.jar -T DepthOfCoverage -R ucsc.hg19.fasta -I /data/$dir1/Data/Intensities/BaseCalls/FINAL_BAMs.list -o /data/$dir1/Data/Intensities/BaseCalls/coverage_report/$dir1 -L /data/Data/NexteraRapidCapture-112662-FINAL-targeted-regions_V1.bed
...
#----------------------------------------------------------------------------------------
#NOW running CNV_static_pooling
# this script will take the "$dir1" from parent shell script.
export dir1;
sh ~/my_tools/NGS_CNV_code/code_for_running_CNV_analysis_static_pooling/step1_code_for_running_CNV_analysis_with_STATIC_pooling.sh
